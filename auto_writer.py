...
def generate_article_html():
    ...
    topics = [
        ...
        "אדמות מושאא וירושות: איך להוציא משכנתא כשהמצב מורכב",
        "משכנתא משולבת: שילוב בין הבנק לגוף חוץ-בנקאי למימון מקסימלי",
        "פריסת משכנתא ל-40 שנה: איך להוריד את ההחזר החודשי",
        "עד 90% מימון כנגד נכס קיים - פתרון מעולה לעזור לילדים",
        "מסורבי בנק? כך תבנו תיק חזק שהמערכת הפיננסית תאשר",
        "ביטוח משכנתא: איך לחסוך עשרות אלפי שקלים בטווח הארוך",
        "איך משתמשים בנכס קיים כדי לגייס הון לכל מטרה?",
        "משכנתא מסחרית בחברה הערבית: איך לממן רכישת מגרש או משרד",
        "סוף לחנק הכלכלי: איך איחוד הלוואות מחזיר את השקט הנפשי",
        "נכס ללא פרצלציה? הפתרונות המיוחדים שיאפשרו לכם לקבל מימון",
        "למה כדאי להיעזר ביועץ שמכיר את המורכבות של החברה הערבית מקרוב",
        "BDI נמוך? עדיין יש לכם פתרונות מימון מצוינים",
        "דירה להשקעה בארץ או בחו\"ל: איך לממן אותה דרך הבית הקיים"
    ]
